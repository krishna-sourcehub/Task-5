...
document.body.scrollIntoView({
    ...
    const [convertedValues, setConvertedValue] = useState('');
    ...
    const handleInputChange = (e) => {
        ...
        setInputValue(value);
        convertValue(value, selectedOption2);
    };
    ...
    const convertValue = (value, option) => {
        let converted;

        switch (option) {
            case 'Bitcoin':
                converted = parseFloat(value *2908125 );
                break;
            case 'Ethereum':
                converted = parseFloat(value *157416);
                break;
            case 'Leo_Token':
                converted = parseFloat(value *3500.79);
                break;
            case 'Solana':
                converted = parseFloat(value *327.62);
                break;
            case 'Dai':
                converted = parseFloat(value *83.17);
                break;
            default:
                break;
        }

        setConvertedValue(isNaN(converted) ? 'Invalid input' : converted);
    };
    ...
    function ValidateRecipientEmail(mail) {
        ...
        alert("You have entered an invalid Receiver email address!");
        return false;
    }
    ...
    function ValidCard(inputValue) {
        ...
        if (isValidNumber) {
            ...
            alert("Invalid  Card number, Please enter 12 digit number");
            // Your error handling logic for an invalid number
        }
    }
    ...
    async function save(event) {
        try {
            await axios.post("http://localhost:8881/api/users/saveUserDetails", {
                ...
                type: type,
                INR_TO: selectedOption2,
                amount: convertedValues,
                                    ...
                                    <div className="row1 align-items-center">
                                        <div className="col-md-6 order-md-1 mb-5 mt-md-0">
                                            <div className="content-block">
                                                ...
                                                <br />
                                                <h3 className="mb-4">
                                                    <b> Crypto Transfer Details</b>
                                                </h3>

                                                <div style={{ marginLeft: "150px" }}>
                                                    {" "}

                                                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style={{ background: 'white', color: 'black', fontFamily: 'sans-serif', width: "180px" }} value={selectedOption2} onChange={handleSelectChange}>
                                                        <option value="Select Currency">Select Currency</option>
                                                        <option value="Bitcoin">Bitcoin</option>
                                                        <option value="Ethereum">Ethereum</option>
                                                        <option value="Leo_Token">Leo Token</option>
                                                ...
                                                <div
                                                    ...
                                                    >
                                                        Send amount{" "}
                                                        <span style={{ marginLeft: "180px" }}>Receive amount</span>{" "}
                                                    </div>
                                    ...
                                    <div className="row1 align-items-center">
                                        ...
                                        >
                                            ...
                                            <div
                                                className="content1"
                                                style={{ marginTop: "46px", marginLeft: "10px" }}>
                                                <div>Recipient Name<span style={{paddingRight:"68px"}}/>: {recipientName}</div>
                                                <div>Recipient Mail<span style={{paddingRight:"76px"}}/> : {recipientMail}</div>
                                                <div>Sender Name <span style={{paddingRight:"80px"}}/>: {senderName}</div>
                                                <div>Sender Credit Card No<span style={{paddingRight:"20px"}}/> : {SenderCard}</div>
                                                <div>Sender Mail <span style={{paddingRight:"92px"}}/>: {senderMail}</div>
                                                <div>Sender Phone Number<span style={{paddingRight:"20px"}}/> : {senderNumber}</div>
                                                <div>INR TO<span style={{paddingRight:"122px"}}/>  : {selectedOption2}</div>
                                                <div>Amount<span style={{paddingRight:"120px"}}/>: {convertedValues}</div>
...
export default Crypto_Transfer;
