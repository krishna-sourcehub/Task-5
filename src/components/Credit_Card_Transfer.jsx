...
const Credit_Card_Transfer = () => {
    ...
    function Validrecipientaccount(inputValue) {
        console.log('Recipient account validation called');
        ...
        if (isValidNumber) {
            ...
            alert("Invalid Recipient Account number please enter 10 digits");
            // Your error handling logic for an invalid number
        }
    ...
    function multifunctioncall() {
        const isValid =
            ...
            Validrecipientaccount(recipientAccount) &&
    ...
    const sendmoney = async () => {
        // Construct the message
        const moneyMessage = `\n\nDear Customer,\n INR ${amount} Credit to your A/C No: ${recipientAccount} on ${currentDate}, through EasyPay Express. `;
        try {
            // Send OTP via API
            await axios.post(
                "http://localhost:8881/api/v1/sms",
                    ...
                    <div className="row1 justify-content-center">
                        <div className="col-lg-8 mb-4">
                            <div className="section-title1 text-center">
                                <p className="text-primary text-uppercase fw-bold mb-3" style={{ fontSize: "20px" }}>International Services</p>
                        ...
                        <div className="col-lg-10">
                            <ul className="payment_info_tab nav nav-pills justify-content-center mb-4" id="pills-tab" role="tablist">
                                ...
                                <li className="nav-item m-2" role="presentation"> <a
                                    className="nav-link btn1 btn1-outline-primary effect-none text-dark " id="pills-how-much-does-it-costs-tab"
                            ...
                            <div className="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
                                            ...
                                            <div className="content-block">
                                                ...
                                                <div style={{ marginTop: "20px" }}>
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" name="recipientName" id="usernme" placeholder="Enter the Recipient Name"
                                                            value={recipientName}
                                                            onChange={(event) => {
                                                    ...
                                                    <div className="form-group">
                                                            <label htmlFor="usernme">
                                                                <i style={{ fontSize: '24px' }} className="fa fa-credit-card"></i>
                                                            </label>
                                                            <input
                                                                type="tel"
                                                                name="senderName"
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="tel" name="recipientNumber" id="usernme" placeholder="Enter the Recipient Phone Number" size="10"
                                                            maxLength="10"
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" name="amount" id="usernme" placeholder="Enter the Amount"
                                                            value={amount}
                                                            onChange={(event) => {
                                    ...
                                    <div className="row1 align-items-center">
                                        <div className="col-md-6 order-md-1 mb-5 mt-md-0">
                                            <div className="content-block"  >
                                                ...
                                                <br />
                                                <h3 className="mb-4"><b>Credit Card Details</b></h3>
                                                <div className="content1" style={{ marginTop: '46px', marginLeft: '10px' }} >
                                                    <div style={{ marginBottom: '0px', marginLeft: '10px' }}>CARD HOLDER <span style={{ marginLeft: '180px' }}>EXPIRATION DATE</span>  </div>

                                                    <div style={{ display: 'flex', gap: '10px' }}>
                                                        <div className="form-group">
                                                            <label htmlFor="usernme">
                                                                <i style={{ fontSize: '32px' }} className="zmdi zmdi-account material-icons-name"></i>
                                                            </label>
                                                            <input
                                                                style={{ width: '400px' }}
                                                                type="text"
                                                        ...
                                                        <div style={{ marginLeft: '40px' }} className="form-group">
                                                            <label htmlFor="usernme">
                                                                <i style={{ fontSize: '24px' }} className="fa fa-calendar"></i>
                                                            </label><span></span>
                                                            <input
                                                                style={{ width: '150px' }}
                                                                type="tel"
                                                        ...
                                                        <span class="date-separator," style={{ fontSize: '30px' }}>/</span>
                                                        <div className="form-group">
                                                            <input
                                                                style={{ width: '150px' }}
                                                                type="tel"
                                                    ...
                                                    <div style={{ marginBottom: '0px', marginLeft: '10px' }}>CARD NUMBER <span style={{ marginLeft: '180px' }}>CV</span>  </div>
                                                    <div style={{ display: 'flex', gap: '10px' }}>
                                                        <div className="form-group">
                                                            <label htmlFor="usernme">
                                                                <i style={{ fontSize: '24px' }} className="fa fa-credit-card"></i>
                                                        ...
                                                        <div className="form-group" style={{ marginLeft: '50px' }}>
                                                            <label htmlFor="usernme">
                                                                <i style={{ fontSize: '24px' }} className="fa fa-critical-role"></i>
                                                            </label>
                                                            <input
                                                                style={{ width: '220px' }}
                                                                type="text"
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="email" name="senderMail" id="usernme" placeholder="Enter the Mail"
                                                            value={senderMail}
                                                            onChange={(event) => {
                                                    ...
                                                    <div className="form-group" >
                                                        <label for="your_name" ><i style={{ fontSize: "22px" }} className="fa fa-phone material-icons-name "></i></label>
                                                        <input type="tel" name="senderNumber" id="usernme" size="10" maxLength="10" placeholder="Enter the Sender Phone Number"
                                                            value={senderNumber}
                                                            onChange={(event) => {
                                        ...
                                        <div className="col-md-6 order-1 order-md-0"><br/><br/>
                                            <div className="image-block text-center">
                                ...
                                <div className="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
                                    ...
                                    <div className="row1 align-items-center" >
                                        ...
                                        <div className="col-md-6 order-md-1 mb-5 mt-md-0" style={{ marginTop: '80px' }}>
                                            <h3 className="mb-4"><b>CONFIRMATION</b><br /></h3>
                                            <div className="content1" style={{ marginTop: '20px', marginLeft: '10px' }} >
                                                <div>Recipient Name <span style={{ paddingRight: "65px" }} />: {recipientName}</div>
                                                <div>Recipient Account <span style={{ paddingRight: "50px" }} />: {recipientAccount}</div>
                                                <div>Recipient Phone Number<span style={{ paddingRight: "3px" }} /> : {recipientNumber}</div>
                                                <div>Sender Name <span style={{ paddingRight: "79px" }} />: {senderName}</div>
                                                <div>Sender Credit Card No<span style={{ paddingRight: "19px" }} /> : {SenderCard}</div>
                                                <div>Sender Mail <span style={{ paddingRight: "90px" }} />: {senderMail}</div>
                                                <div>Sender Phone Number<span style={{ paddingRight: "18px" }} /> : {senderNumber}</div>
                                                <div>Amount<span style={{ paddingRight: "116px" }} /> : {amount}</div>
                                                <div>Description<span style={{ paddingRight: "94px" }} /> : {shortDescription}</div>
                                                <div style={{ display: "flex", gap: "10px" }}>
                                                    {" "}
...
export default Credit_Card_Transfer;
...
//         <p>Show something for Option 1</p>
...
//         <p>Show something for Option 2</p>
//     </div>
// )}
// </div>