...
const UPI_Transfer = () => {
    ...
    function validateRecipientUPI(name) {
        console.log('Recipient UPI validation called');
        const isValidInput = /^[a-zA-Z ]+$/.test(name);

        if (isValidInput) {
            // Proceed with your logic for a valid input
            console.log('Input Recipient is a valid UPI');
            return true;
        } else {
            // Handle the case for an invalid input
            alert('Enter a valid Recipient UPI');
            // You can show an error message or take other actions
        }
    }

    function validSenderUPI(name) {
        console.log('Sender UPI validation called');
        const isValidInput = /^\d{10}$/.test(name);

        if (isValidInput) {
            // Proceed with your logic for a valid input
            console.log('Input Sender is a valid UPI');
            return true;
        } else {
            // Handle the case for an invalid input
            alert('Enter a valid Sender UPI');
            // You can show an error message or take other actions
        }
    }
    ...
    const sendmoney = async () => {
        // Construct the message
        const moneyMessage = `\n\nDear Customer,\n INR ${amount} Credit to your UPI ID: ${recipientUPI} on ${currentDate}, through EasyPay Express. `;
        try {
            // Send OTP via API
            await axios.post(
                "http://localhost:8881/api/v1/sms",
                            ...
                            <div className="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
                                            ...
                                            <div className="content-block">
                                                ...
                                                <div style={{ marginTop: "76px" }}><div className="form-group">
                                                    ...
                                                    <div className="form-group">
                                                        <label for="your_name" ><i style={{ fontSize: "22px" }} className="fa fa-ravelry "></i></label>
                                                        <input type="text" name="recipientName" id="usernme" placeholder="Enter the Recipient UPI ID" style={{ width: "400px" }}
                                                            value={recipientUPI}
                                                            onChange={(event) => {
                                        ...
                                        <div className="col-md-6 order-1 order-md-0">
                                            <div className="content-block">
                                                ...
                                                <div style={{ marginTop: "76px" }}><div className="form-group">
                                                    ...
                                                    <div className="form-group">
                                                        <label for="your_name" ><i style={{ fontSize: "22px" }} className="fa fa-ravelry "></i></label>
                                                        <input type="text" name="senderUPI" id="userUPI" placeholder="Enter the Sender UPI ID" style={{ width: "400px" }}
                                                            value={senderUPI}
                                                            onChange={(event) => {
                                                                setsenderUPI(event.target.value);
                                                            }} required />
                                                    </div>
                                ...
                                <div className="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
                                    ...
                                    <div className="row1 align-items-center">
                                        ...
                                        <div className="col-md-6 order-1 order-md-0">
                                            <div>Recipient Name <span style={{ paddingRight: "60px" }} />: {recipientName}</div>
                                            <div>Recipient UPI ID <span style={{ paddingRight: "60px" }} />: {recipientUPI}</div>
                                            <div>Recipient Phone Number : {recipientNumber}</div>
                                            <div>Description <span style={{ paddingRight: "92px" }} />: {shortDescription}</div>
                                            <div>Sender Name<span style={{ paddingRight: "82px" }} />: {senderName}</div>
                                            <div>Sender UPI ID<span style={{ paddingRight: "76px" }} /> : {senderUPI}</div>
                                            ...
                                            <div>Amount <span style={{ paddingRight: "114px" }} />: {amount}</div>
