...
const user=localStorage.getItem('username');
    ...
    function validatesenderAccount(inputValue) {
        ...
        console.log('Sender Account validation called');
        if (isValidInput) {

            console.log(' Sender Account a valid 10-digit number');
            return true;
        } else {
            alert('Sender Account is not a valid 10-digit number');
        }
    }
    ...
    function validateRecipientAccount(inputValue) {
        ...
        if (isValidInput) {
            console.log(' Recipient Account a valid 10-digit number');
            return true;
        } else {
            alert('Recipient Account is not a valid 10-digit number');
        }
    }
    ...
    const sendmoney = async () => {
        ...
        try {
            ...
            await axios.post(
                "http://localhost:8881/api/v1/sms",
                {
                    phoneNumber: "+91" + recipientNumber,
                            ...
                            <div className="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
                                            ...
                                            <div className="content-block">
                                                ...
                                                <div style={{ marginTop: "76px" }}><div className="form-group">
                                                    ...
                                                    <div className="form-group">
                                                        <label for="your_name" ><i style={{ fontSize: "22px" }} className="fa fa-bank material-icons-name "></i></label>
                                                        <input type="text" name="recipientAccount" id="usernme" placeholder="Enter the Recipient Account Number" style={{ width: "400px" }}
                                        ...
                                        <div className="col-md-6 order-1 order-md-0">
                                            <div className="content-block">
                                                ...
                                                <div style={{ marginTop: "76px" }}><div className="form-group">
                                                    ...
                                                    <div className="form-group">
                                                        <label for="your_name" ><i style={{ fontSize: "22px" }} className="fa fa-bank material-icons-name "></i></label>
                                                        <input type="number" name="senderAccountNumber" id="usernme" placeholder="Enter the Sender Account Number" style={{ width: "400px" }}
                                                            value={senderAccount}
                                                            onChange={(event) => {
                                ...
                                <div className="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
                                    ...
                                    <div className="row1 align-items-center">
                                        ...
                                        <div className="col-md-6 order-1 order-md-0">
                                            <div>Recipient Name <span style={{ paddingRight: "60px" }}></span>: {recipientName}</div>
                                            <div>Recipient Account<span style={{ paddingRight: "50px" }}></span>: {recipientAccount}</div>
                                            ...
                                            <div>Sender Account <span style={{ paddingRight: "60px" }}></span> : {senderAccount}</div>
