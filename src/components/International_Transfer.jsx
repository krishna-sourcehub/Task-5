...
document.body.scrollIntoView({
    ...
    const convertValue = (value, option) => {
        ...
        switch (option) {
            case 'Dollar':
                converted = parseFloat(value * 83.22);
                break;
            case 'Euro':
                converted = parseFloat(value * 89.19);
                break;
            case 'Sol':
                converted = parseFloat(value * 22.13);
                break;
            default:
                break;
        }
    ...
    function validateRecipientname(name) {
     ...
     function ValidCard(inputValue) {
        ...
        if (isValidNumber) {
            ...
            alert("Invalid Valid Card number enter valid 12 digit number");
            // Your error handling logic for an invalid number
        }
    }
                                    ...
                                    <div className="row1 align-items-center">
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                <div>Recipient Mail<span style={{paddingRight:"78px"}}/> : {recipientMail}</div>
                                                <div>Sender Name <span style={{paddingRight:"82px"}}/>: {senderName}</div>
                                                <div>Sender Credit Card No <span style={{paddingRight:"22px"}}/> : {SenderCard}</div>
                                                ...
                                                <div>INR TO <span style={{paddingRight:"124px"}}/>: {selectedOption2}</div>
                                                <div>Amount <span style={{paddingRight:"118px"}}/>: {convertedValue}</div>
                                                <div>Description<span style={{paddingRight:"96px"}}/> : {shortDescription}</div>
                                                <div style={{ display: "flex", gap: "10px" }}>
                                                {" "}
...
export default International_Transfer;
