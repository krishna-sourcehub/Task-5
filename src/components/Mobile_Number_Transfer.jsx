...
const Mobile_Number_Transfer = () => {
    ...
    const sendmoney = async () => {
        // Construct the message
        const moneyMessage = `\n\nDear Customer,\n INR ${amount} Credit to your Phone NO: ${recipientNumber} on ${currentDate}, through EasyPay Express. `;
        try {
            // Send OTP via API
            await axios.post(
                "http://localhost:8881/api/v1/sms",
    ...
    var type = "Immediate Payment Service (IMPS)"
...
export default Mobile_Number_Transfer;