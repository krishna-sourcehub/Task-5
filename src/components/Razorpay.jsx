...
const Razorpay = () => {
    ...
    function Recipientphonechange1(inputValue) {
        ...
        if (isValidNumber) {
            console.log("Valid Recipent phone number");
            return true;
    ...
    const sendmoney = async () => {
        // Construct the message
        const moneyMessage = `\n\nDear Customer,\n INR ${amounts} Credit to your Mail : ${recipientMail} on ${currentDate}, through EasyPay Express. `;
        try {
            // Send OTP via API
            await axios.post(
                "http://localhost:8881/api/v1/sms",
    ...
    function RazorpaySubmit() {
        if (amounts === "") {
            ...
            var options = {
                key: "rzp_test_alRGBM5NkI5Hku",
                key_secret: "9fVZQr6aPs6D8HildGwCn2Lo",
                amount: amounts * 100,
                currency: "INR",
                name: "EasyPay Express",
                ...
                prefill: {
                    name: "EasyPay Express",
                    email: "easypayexpress@gmail.com",
                    contact: "55652351"
                },
                notes: {
                                                    ...
                                                    <div
                                                        ...
                                                        <div >
                                                            <div className="form-group">
                                                                ...
                                                                <input style={{ width: "800px" }} type="text" name="senderName" id="usernme"
                                                        ...
                                                        <div className="form-group">
                                                                ...
                                                                <input style={{ width: "800px" }} type="text" name="senderName" id="usernme"
                                                                    ...
                                                                    size="10"
                                                                    maxLength="10"
                                                                    value={recipientNumber} onChange={(e) => setPhoneNumber(e.target.value)}
                                                                    required
                                                                />
                                                            </div>
                                        ...
                                        <div className="row1 align-items-center">
                                            ...
                                            >
                                                ...
                                                <div
                                                    className="content1"
                                                    style={{ marginTop: "46px", marginLeft: "10px" }}>
                                                    <div>Recipient Name <span style={{ paddingRight: "64px" }} />: {recipientName}</div>
                                                    <div>Recipient Phone Number<span style={{ paddingRight: "3px" }} /> : {recipientNumber}</div>
                                                    <div>Recipient Mail<span style={{ paddingRight: "75px" }} /> : {recipientMail}</div>
                                                    ...
                                                    <div>Type <span style={{ paddingRight: "138px" }} />: {type}</div>
                                                    <div>Amount <span style={{ paddingRight: "116px" }} />: {amounts}</div>
                                                    <div>Description <span style={{ paddingRight: "95px" }} /> : {shortDescription}</div>
                                                    <div style={{ display: "flex", gap: "10px" }}>
                                                        {" "}
                                                        <div style={{ marginTop: "24px" }}>Enter OTP<span style={{ paddingRight: "106px" }} /> :</div>
                                                        <div>
                                                            {" "}
                                                            <input
                                                                type="text"
